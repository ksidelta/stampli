...
import pizza from '../img/approval_black_24dp.svg';
    ...
    <RouterServiceContext.Consumer>
      {historyService => (
        <AppBar
          ...
          <Toolbar>
            {' '}
            {/* We can also use "BottomNavigation element */}
            <Box sx={{ flexGrow: 1 }} />
            <StyledIconButton color="inherit" aria-label="restaurant menu" onClick={() => historyService.goToMenu()}>
            ...
            <Box sx={{ flexGrow: 2 }} />
            <StyledIconButton color="inherit" aria-label="discounts" onClick={() => historyService.goToDiscountPage()}>
            ...
            <StyledIconButton
              color="inherit"
              aria-label="options"
              onClick={() => historyService.goToBusinessOptionsPage()}>
